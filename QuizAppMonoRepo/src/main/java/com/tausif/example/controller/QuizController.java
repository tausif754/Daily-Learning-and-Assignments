...
import com.tausif.example.entities.QuestionWrapper;
import com.tausif.example.entities.Quiz;
import com.tausif.example.entities.Response;
...
public class QuizController {
    ...
    public Quiz createQuiz(
    	...
    	log.info("Creating quiz - Category: {}, Level: {}, Title: {}", category, level, title);
